  ...
  products: [
    {
      ...
      description:
        "We can supply this product small as well as large quantitiy as per customers requirement. HPLC purity will be >98%",
    ...
    },
    {
      ...
      description:
        "We are manufacturing this product. We can supply this product as per customer requirements. \n\n",
      images: [
    ...
    },
    {
      ...
      description:
        "We can supply this product small as well as large quantity as per customers requirement. GC purity will be >95% \n\n",
      additionalInformation: {
    ...
    },
    {
      ...
      description:
        "We are manufacturing this product and can supply as per customer requirements. Send your queries to this mai \n\n",
      images: [
    ...
    },
    {
      ...
      description:
        "We can supply this small as well as large quantities. More than 500 gm product in stock. Send your queries to this\n\n",
      additionalInformation: {
        "Production Capacity": "10 kg/month",
        "Delivery Time": "As per quantity",
      },
    ...
    },
    {
      ...
      description:
        "White soild, Purity = 99%, Quantity as per customer requirement. Send your queries to this mail id\n\n",
      additionalInformation: { "Delivery Time": "As per quantity" },
      images: [
    ...
    },
    {
      ...
      description:
        "We can supply this product as per customer requirements. Send your queries to this mail id, info@sinnchem.com\n\n",
      additionalInformation: { "Delivery Time": "As per quantity" },
      images: [
    ...
    },
    {
      ...
      additionalInformation: {
        ...
        "Delivery Time": "As per quantity",
        "Packaging Details":
          "Material packed in HDPE Can in 1 kg, 5 kg and 25 kg quantity",
      },
      images: [
    ...
    },
    {
      ...
      name: "Dimethyl Acetone Dicarboxylate",
      category: "Speciality Chemical",
      price: 9000,
      minimumQuantity: 1,
      specification: {
      ...
      description:
        "We can supply small as well as large quantity, as per customers requirement. GC purity will be >98%\n\n",
      additionalInformation: {
        "Delivery Time": "As per quantity",
        "Packaging Details": "Material packed in HDPE Can",
      },
    ...
    },
    {
      ...
      name: "N-Acetyl Thiazolidine-4-Carboxylic Acid (NATCA)",
      ...
      description:
        "We are manufacturing N-Acetyl Thiazolidine-4-carboxylic acid(NATCA, Cas no 5025-82-1) in bulk quantities. It is detected NATCA, HPLC purity will be >99%. Made in India. Ready stocks. We can provide free samples to the customers. We can supply any quantity as per customer requirements.\n\n",
      additionalInformation: { "Delivery Time": "As per quantity" },
      images: [
    ...
    },
    {
      ...
      description:
        "We are manufacturing this product and can supply as per customer requirements. Since it is low melting solid, so we can give our customer clean NMR data.",
      additionalInformation: {
        "Production Capacity": "5 kg/month",
        "Delivery Time": "As per quantity",
      },
    ...
    },
    {
      ...
      description:
        "This chemical we are making in gm scale but we can supply as per customer requirement.",
      additionalInformation: { "Delivery Time": "Depends of quantity" },
      images: [
    ...
    },
    {
      ...
      name: "tert-Butyl 3,3-difluro-1,8-diazaspiro [4,5] decane-8carboxylate",
      category: "New Items",
      specification: {
        Purity: "95%",
        "Grade Standard": "Reagent Grade",
      ...
      description:
        "This chemical we are making in gram scale but we can supply as per customer requirement.",
      additionalInformation: { "Delivery Time": "Depends of quantity" },
      images: [
    ...
    },
    {
      ...
      description:
        "We can supply small as well as large quantity as per customer requirements. Send your queries to this mail id",
      additionalInformation: { "Delivery Time": "Depends of quantity" },
      images: [
